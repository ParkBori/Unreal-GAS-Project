...
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FJumpAndWaitForLandgindDelegate);

/**
 * 
 */
UCLASS()
class GASSTUDY_API UAT_JumpAndWaitForLanding : public UAbilityTask
{
	GENERATED_BODY()
...
public:
	...
	FJumpAndWaitForLandgindDelegate OnComplete;
