...
#include "GA_TestAbilityTemplate.generated.h"

/**
 * 
 */
UCLASS()
class GASSTUDY_API UGA_TestAbilityTemplate: public UGameplayAbility
{
	GENERATED_BODY()
	
public:
	UGA_TestAbilityTemplate();
...
public:
	...
	UFUNCTION()
	void WaitEventCallBackFunc(FGameplayEventData Payload);


protected:
	class UAbilityTask_WaitGameplayEvent* WaitEvent;
};
